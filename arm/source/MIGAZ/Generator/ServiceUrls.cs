...
namespace MIGAZ.Generator
{
    static class ServiceUrls
    {
        ...
        {
            {  "Azure Auth", new[] { "https://management.core.windows.net/", "https://login.windows.net/" } },
            {  "Graph Auth", new[] { "https://graph.windows.net/", "https://login.windows.net/" } },
            {  "Azure Cloud", new[] { "https://management.azure.com/", "https://login.windows.net/" } },
