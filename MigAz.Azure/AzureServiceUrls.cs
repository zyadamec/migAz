...
namespace MigAz.Azure
{
    public class AzureServiceUrls
    {
        ...
        private Dictionary<string, string[]> _serviceUrls = new Dictionary<string, string[]>
        {
            ...
            {  "AzureGermanCloud", new[] { "https://management.core.cloudapi.de/", "https://management.microsoftazure.de/",  "https://login.microsoftonline.de/", "core.cloudapi.de", "blob.core.cloudapi.de", "https://graph.windows.net/" } },
