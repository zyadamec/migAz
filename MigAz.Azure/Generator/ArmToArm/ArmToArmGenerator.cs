...
namespace MigAz.Azure.Generator.ArmToArm
{
    public class ArmToArmGenerator : TemplateGenerator
    {
        ...
        private void BuildARMVirtualNetworkObject(Arm.VirtualNetwork armVirtualNetwork)
        {
            ...
            else
            {
                foreach (Arm.Subnet armSubnet in armVirtualNetwork.Subnets)
                {
                    ...
                    // todo if (armSubnet.NetworkSecurityGroup != null)
                    //{
                    ...
                    // todo if (subnet.properties.routeTable != null)
                    //{
                    //    RouteTable routetable = BuildARMRouteTable(null); // todo null with variable
        ...
        //private NetworkSecurityGroup BuildARMNetworkSecurityGroup(Arm.NetworkSecurityGroup networkSecurityGroup)
        //{
