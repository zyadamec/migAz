...
namespace MigAz.AzureStack
{
    public class AdminSubscription : AzureSubscription
    {
        ...
        private AdminSubscription() : base(null, null, new AzureEnvironment(AzureEnvironmentType.Azure, "NotAvailable", String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty), String.Empty, String.Empty)
        { }
