...
namespace MigAz.AWS.Generator
{
    public class AwsGenerator : TemplateGenerator
    {
        ...
        private AwsGenerator() : base(null, null, null, null, null) { }

        public AwsGenerator(ILogProvider logProvider, IStatusProvider statusProvider) : base(null, logProvider, statusProvider, null, null)
        {
        }
