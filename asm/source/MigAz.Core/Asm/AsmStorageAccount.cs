...
{
    public class AsmStorageAccount : IStorageAccount
    {
        #region Variables

        private AzureContext _AzureContext;
        private XmlNode _XmlNode = null;
        private AsmStorageAccountKeys _AsmStorageAccountKeys;
        ...
        private AsmStorageAccount() { }


        public AsmStorageAccount(AzureContext azureContext, XmlNode xmlNode)
        {
        ...
        public AsmStorageAccountKeys Keys
        {
