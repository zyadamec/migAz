...
namespace MigAz.Azure.Asm.Generator
{
    public class TemplateResult
    {
        ...
        //private Dictionary<string, string> _ProcessedItems = new Dictionary<string, string>();
        ...
        //public Dictionary<string, string> ProcessedItems { get { return _ProcessedItems; } }
